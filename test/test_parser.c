...
void test_parser_declaration_of_var(void) {
	...
	TEST_ASSERT_EQUAL_INT_MESSAGE(
	    0, result, "The parser has rejected a valid variable declaration");
}
...
void test_parser_invalid_declaration_of_var(void) {
	...
	int result = parse_string(code);
	TEST_ASSERT_EQUAL_INT_MESSAGE(
	    1, result, "The parser accepted code with invalid syntax");
}
...
void test_parser_valid_int_method_declare(void) {
	...
	int result = parse_string(code);
	TEST_ASSERT_EQUAL_INT_MESSAGE(
	    0, result, "The parser rejected a valid method declaration");
}
...
void test_parser_invalid_int_method_declare(void) {
	...
	int result = parse_string(code);
	TEST_ASSERT_EQUAL_INT_MESSAGE(
	    1, result, "The parser encountered an invalid method declaration");
}
...
void test_parser_valid_method_call(void) {
	...
	int result = parse_string(code);
	TEST_ASSERT_EQUAL_INT_MESSAGE(
	    0, result, "El parser rechazó una llamada de método válida");
}
...
void test_parser_invalid_method_call(void) {
	...
	int result = parse_string(code);
	TEST_ASSERT_EQUAL_INT_MESSAGE(
	    1, result, "The parser encountered an invalid method call");
}
...
void test_parser_valid_asing_operation(void) {
	...
	TEST_ASSERT_EQUAL_INT_MESSAGE(0, result,
	                              "The parser rejected a valid assignment");
}
...
void test_parser_invalid_asing_operation(void) {
	...
	int result = parse_string(code);
	TEST_ASSERT_EQUAL_INT_MESSAGE(
	    1, result, "The parser encountered an invalid assignment");
}
...
void test_parser_valid_if_then_operation(void) {
	...
	int result = parse_string(code);
	TEST_ASSERT_EQUAL_INT_MESSAGE(
	    0, result, "The parser rejected a valid ‘if then’ operation");
}
...
void test_parser_invalid_if_then_operation(void) {
	...
	int result = parse_string(code);
	TEST_ASSERT_EQUAL_INT_MESSAGE(
	    1, result, "The parser encountered an invalid ‘if then’ operation");
}
...
void test_parser_valid_if_then_else_operation(void) {
	...
	int result = parse_string(code);
	TEST_ASSERT_EQUAL_INT_MESSAGE(
	    0, result, "The parser rejected a valid ‘if-then-else’ operation");
}
...
void test_parser_invalid_if_then_else_operation(void) {
	...
	int result = parse_string(code);
	TEST_ASSERT_EQUAL_INT_MESSAGE(
	    1, result, "The parser encountered an invalid if-then-else statement");
}
...
void test_parser_valid_return_operation(void) {
	...
	int result = parse_string(code);
	TEST_ASSERT_EQUAL_INT_MESSAGE(
	    0, result, "The parser rejected a valid return operation");
}
...
void test_parser_invalid_return_operation(void) {
	...
	int result = parse_string(code);
	TEST_ASSERT_EQUAL_INT_MESSAGE(
	    1, result, "The parser encountered an invalid return operation");
}
...
void test_parser_valid_return_expr_operation(void) {
	...
	int result = parse_string(code);
	TEST_ASSERT_EQUAL_INT_MESSAGE(
	    0, result, "The parser rejected a valid ‘return expression’ operation");
}
...
void test_parser_invalid_return_expr_operation(void) {
	...
	TEST_ASSERT_EQUAL_INT_MESSAGE(
	    1, result,
	    "The parser encountered an invalid ‘return expression’ operation");
}
...
void test_parser_valid_while_operation(void) {
	...
	int result = parse_string(code);
	TEST_ASSERT_EQUAL_INT_MESSAGE(
	    0, result, "The parser rejected a valid ‘while’ operation");
}
...
void test_parser_invalid_while_operation(void) {
	...
	int result = parse_string(code);
	TEST_ASSERT_EQUAL_INT_MESSAGE(
	    1, result, "The parser encountered an invalid `while` statement");
}
...
void test_parser_valid_line_comment(void) {
	...
	int result = parse_string(code);
	TEST_ASSERT_EQUAL_INT_MESSAGE(0, result,
	                              "The parser rejected a valid Comment");
}

void test_parser_invalid_line_coment(void) {
	const char *code =
	    "int main(){int x; x = 3; //This is e faild line comment}";
	int result = parse_string(code);
	TEST_ASSERT_EQUAL_INT_MESSAGE(1, result,
	                              "The parser acept an invalid Comment");
}

void test_parser_valid_multiple_line_comment(void) {
	const char *code =
	    "int main(){int x; x = 3; /*This is a comment \n Dear God \n And "
	    "the're more\n NO \n It contains a comment \n */  return 3 + x;}";
	int result = parse_string(code);
	TEST_ASSERT_EQUAL_INT_MESSAGE(
	    0, result, "The parser rejected a valid multiple line Comment");
}
...
void test_parser_invalid_multiple_line_coment(void) {
	...
	int result = parse_string(code);
	TEST_ASSERT_EQUAL_INT_MESSAGE(
	    1, result, "The parser acept an invalid multiple line Comment");
}
